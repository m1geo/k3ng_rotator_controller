...
#define rotate_cw 4              // goes high to activate rotator R (CW) rotation - pin 1 on Yaesu connector
#define rotate_ccw 5             // goes high to activate rotator L (CCW) rotation - pin 2 on Yaesu connector
...
/*----------- elevation pins --------------*/
  ...
  #define rotate_up 6               // goes high to activate rotator elevation up
  #define rotate_down 7             // goes high to activate rotator elevation down
